function [vrb_trajectories] = VRB_traj(init_pose,final_pose)
% clear;
% clear all;
%Virtual rigid body trajectory
% init_pose = [10,3,20,0];
% final_pose = [20,30,10.01,0];
init_pose = init_pose';
init_pose = [init_pose 0];
final_pose = final_pose';
final_pose = [final_pose 0];
...
fun = @(tf) double(Fun_obj(tf,init_pose,final_pose));
nonlcon = @(tf) Fun_cond(tf,init_pose,final_pose,0);
...
vrb_trajectories = [f1;f2;f3;f4;df1;df2;df3;df4;ddf1;ddf2;ddf3;ddf4;d3f1;d3f2;d3f3;d3f4;d4f1;d4f2;d4f3;d4f4;tf];
end
